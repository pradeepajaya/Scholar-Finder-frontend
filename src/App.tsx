...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      {/* Header - Only show for non-institution and non-admin users */}
      {userType !== "institution" && userType !== "admin" && (
        <header className="border-b border-slate-200 bg-white/80 backdrop-blur-sm sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 py-4 bg-[rgba(8,75,248,0.1)]">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex items-center gap-6">
                <button
                  onClick={() => setCurrentPage("home")}
                  className={`text-base font-bold transition-colors px-3 py-1.5 rounded-md ${
                    currentPage === "home"
            ...
            {mobileMenuOpen && (
              <nav className="md:hidden mt-4 pb-4 flex flex-col gap-3">
                <button
                  ...
                  className={`text-sm transition-colors text-left px-3 py-2 rounded-md ${
                    currentPage === "home"
